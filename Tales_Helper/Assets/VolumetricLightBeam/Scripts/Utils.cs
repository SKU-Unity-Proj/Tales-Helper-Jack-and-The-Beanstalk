...
namespace VLB
{
    public static class Utils
    {
        ...
        public static float GetVolumeCubic(this UnityEngine.Bounds self) { return self.size.x * self.size.y * self.size.z; }
        public static float GetMaxArea2D(this UnityEngine.Bounds self) { return Mathf.Max(Mathf.Max(self.size.x * self.size.y, self.size.y * self.size.z), self.size.x * self.size.z); }
