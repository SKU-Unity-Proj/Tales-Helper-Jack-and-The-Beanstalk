...
half _MetallicIntensity;        // ¸ÞÅ»¸¯ °­µµ
half _OcclusionStrength;        // ¿ÀÅ¬·çÀü °­µµ
...
// ÅØ½ºÃÄ¶û »ùÇÃ·¯ Ãß°¡ÇÑ°Å
TEXTURE2D(_MetallicMap);        SAMPLER(sampler_MetallicMap);   // ¸ÞÅ»¸¯ ¸Ê ÅØ½ºÃ³ ¸ÞÅ»¸¯ ¸Ê »ùÇÃ·¯
TEXTURE2D(_OcclusionMap);       SAMPLER(sampler_OcclusionMap); // ¿ÀÅ¬·çÀü ¸Ê ÅØ½ºÃ³ ¿ÀÅ¬·çÀü ¸Ê »ùÇÃ·¯
